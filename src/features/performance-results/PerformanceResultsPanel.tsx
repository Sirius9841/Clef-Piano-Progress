...
function ReadyResults({ results, scope, onAnalyze, onHighlightChange }: { results: PerformanceResults; scope: GradingScopeType; onAnalyze: (scope: GradingScopeType) => void; onHighlightChange: (model: ScoreHighlightModel | null) => void }) {
...
export function PerformanceResultsPanel({ analysis, scope, onAnalyze, onHighlightChange }: { analysis: PerformanceResultsAnalysisState; scope: GradingScopeType; onAnalyze: (scope: GradingScopeType) => void; onHighlightChange: (model: ScoreHighlightModel | null) => void }) {
  ...
  return <ReadyResults key={analysis.result.id} results={analysis.result} scope={scope} onAnalyze={onAnalyze} onHighlightChange={onHighlightChange} />
}
