...
export function HistoricalVoicingPanel({ result }: { result: VoicingAnalysisResult | null }) {
  if (!result) return <section className="panel voicing-analysis"><h2>Voicing</h2><div className="voicing-empty"><strong>Not analyzed for this historical attempt</strong><p>Voicing is not configured / unavailable in this saved snapshot. Current preferences do not rewrite it.</p></div></section>
