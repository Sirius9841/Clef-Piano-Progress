...
Phase 9 adds Dynamics and Articulation beside this Phase 7 result map, and Phase 10 adds Pedal beside them. None is added to measure aggregation, the 45/35/20 Practice Priority, AttemptSummary, personal bests, or trends. An overall Performance Score, Mastery changes, reference-performance expression, and transferable Skill Ratings remain deferred.

These metrics are evidence about structural correctness, technical control, or authored fidelity; they are not a single objective judgment of artistic quality. Phase 10.1 specifically lets Pedal follow trustworthy locally aligned musical arrivals so expressive timing is not punished once in Timing/Tempo and again merely for departing from a global clock. Future reference-performance comparisons must describe differences and alternatives, not treat one rendition as expressive ground truth.
