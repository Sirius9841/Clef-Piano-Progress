...
The current progress model deliberately excludes Mastery, clean playable tempo, Dynamics, Articulation, and Pedal personal bests/trends, Technique Lab ratings, and an overall performance score. Phase 9 expression and Phase 10 pedal snapshots remain visible per attempt but are not headline longitudinal metrics.
